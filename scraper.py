...
#numpy tool to iterate over for loop by 100 (8 pages in this example)
...
for i in pages:
   ...
   #based on tags, relevant info is in tbody, all the rows of data are in tr
...
#extra code to showcase dropna function for dity data
