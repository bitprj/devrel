...
**Intents:**
Intents are actions that a user can perform on your agent. You can set up as many intents as you want for your agent. When a user says something, DialogFlow will match the expression with one of the intents that you created. For example, you may have a “Shipping” intent. When a user asks “What are the shipping methods?“ the Chatbot will match it with the “Shipping” intent. In this way, users can get correct responses. The Chatbot knows which intent to call by using entities.
