...
Step 4: Play With It
By running npm start, this window should pop up on the top left corner on your screen. It has two text input fields for entering desired minutes and seconds.
![2](./2.png)
